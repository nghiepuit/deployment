...
var SESSION_SECRET = process.env.SESSION_SECRET || 'shopnx5-secret';
    ...
    function AuthService() {
        ...
        _this.isAuthenticated = function () {
            return compose()
                ...
                .use(function (req, res, next) {
                user_model_1.default.findById(req.user._id).exec() //.select('_id email name role avatar active provider')
                    .then(function (user) {
                    if (!user) {
         ...
         * Otherwise blank
         */
        _this.attachRegisterUserInfo = function () {
            return compose()
        ...
        _this.hasRoles = function (roleRequired) {
            ...
            return compose()
                ...
                for (var _i = 0, roleRequired_1 = roleRequired; _i < roleRequired_1.length; _i++) {
                    var role = roleRequired_1[_i];
