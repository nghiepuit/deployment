...
user_model_1.default.find(function (err, data) {
    if (data.length < 1) {
        user_model_1.default.create({
            ...
            user_model_1.default.find({}, function (err, data) { data.forEach(function (data) { data.save(); }); });
...
address_model_1.default.find(function (err, data) {
    if (data.length < 1) {
        address_model_1.default.create({
            ...
            address_model_1.default.find({}, function (err, data) { data.forEach(function (data) { data.save(); }); });
            console.log('finished populating address');
        });
    }
});
shipping_model_1.default.find(function (err, data) {
    if (data.length < 1) {
        shipping_model_1.default.create({
            ...
            shipping_model_1.default.find({}, function (err, data) { data.forEach(function (data) { data.save(); }); });
            console.log('finished populating shippings');
        });
    }
});
coupon_model_1.default.find(function (err, data) {
    if (data.length < 1) {
        coupon_model_1.default.create({
            ...
            coupon_model_1.default.find({}, function (err, data) { data.forEach(function (data) { data.save(); }); });
...
feature_model_1.default.find(function (err, data) {
    if (data.length < 1) {
        feature_model_1.default.create({
            ...
            feature_model_1.default.find({}, function (err, data) { data.forEach(function (data) { data.save(); }); });
            console.log('finished populating features');
        });
    }
});
product_model_1.default.find(function (err, data) {
    if (data.length < 1) {
        product_model_1.default.create({
            ...
            "variants": [
                {
                    "image": "jPFrHVIis_Lh_gp7HLolDnOs.jpg",
                    "mrp": 2299,
                    "price": 2299,
                    "size": "30",
            ...
            "variants": [
                {
                    "image": "IHEVbE34afH8D_W7TFR4vJlA.jpg",
                    "mrp": 2599,
                    "price": 2599,
                    "size": "M",
            ...
            "variants": [
                {
                    "image": "-KBlIEp5vF2oMyuKqE9EgNWv.jpg",
                    "mrp": 2599,
                    "price": 2599,
                    "size": "M",
            ...
            "variants": [
                {
                    "size": "S",
                    "image": "Nkjo1oJY0RISOUCMDMx_IE-7.jpg",
                    "mrp": 3299,
                    "price": 3299,
            ...
            "variants": [
                {
                    "size": "S",
                    "image": "m3DWWG6cqzYzbvBMbRVX3w0-.jpg",
                    "mrp": 3299,
                    "price": 3299,
            ...
            "variants": [
                {
                    "image": "CPDeV2S-ku75siwbMmfYWVzv.jpg",
                    "mrp": 7990,
                    "price": 7990,
                    "size": "30",
            ...
            "variants": [
                {
                    "image": "ObBHwxqiTgsKf5WEzzmAhsQX.jpg",
                    "mrp": 7990,
                    "price": 7990,
                    "size": "30",
            ...
            "variants": [
                {
                    "image": "6wuVnfABGn_cervN2GaZNduB.jpg",
                    "mrp": 1499,
                    "price": 1499,
                    "size": "S",
            ...
            "variants": [
                {
                    "image": "6KhT0jQ2BRPayJI0A3qNOqzh.jpg",
                    "mrp": 2599,
                    "price": 2599,
                    "size": "30",
            ...
            "variants": [
                {
                    "image": "xVFdJqCjhQC-xHq3ctAn8QCp.jpg",
                    "mrp": 2599,
                    "price": 2599,
                    "size": "30",
            ...
            "variants": [
                {
                    "size": "S",
                    "image": "OtZ3me5Rxf0mlMLuH4otg3fd.jpg",
                    "mrp": 1399,
                    "price": 1399,
            ...
            "variants": [
                {
                    "image": "16KNgfKYW1_m0MWQ4OhDHfUf.jpg",
                    "mrp": 3999,
                    "price": 3999,
                    "size": "S",
            ...
            "variants": [
                {
                    "image": "DIWE3iQDN20_4z9zaDPHBGqO.jpg",
                    "mrp": 1799,
                    "price": 1799,
                    "size": "30",
            ...
            "variants": [
                {
                    "image": "kS9YNER3d7RyD-m3242GHPIr.jpg",
                    "mrp": 1299,
                    "price": 1299,
                    "size": "XS",
            ...
            "variants": [
                {
                    "size": "6",
                    "image": "N0qwYTCEbnT-PixxA4LlXMwq.jpg",
                    "mrp": 2290,
                    "price": 2290,
            ...
            "variants": [
                {
                    "image": "C6IK14QwmDI55pbnx3MaAFnc.jpg",
                    "mrp": 2690,
                    "price": 2690,
                    "size": "6",
            ...
            "variants": [
                {
                    "image": "Ttc_9o-wszooYmre0blxfbr3.jpg",
                    "mrp": 3690,
                    "price": 3690,
                    "size": "6",
            ...
            "variants": [
                {
                    "image": "-PfYR4ydCwb_uIUobGtcOb48.jpg",
                    "mrp": 660,
                    "price": 660,
                    "size": "S",
            ...
            "variants": [
                {
                    "image": "SQUkzlVVSs0qObd2XBcz_tZa.jpg",
                    "mrp": 2975,
                    "price": 2975,
                    "size": "M",
            ...
            "variants": [
                {
                    "size": "XS",
                    "image": "Wbl-Ry9brtRVxFV7mJ_OIn2u.jpg",
                    "mrp": 1599,
                    "price": 1599,
            ...
            "variants": [
                {
                    "size": "S",
                    "image": "q_YaGxfFSoalAmDHxIoL5rVy.jpg",
                    "mrp": 2299,
                    "price": 2299,
            ...
            "variants": [
                {
                    "image": "G8zyaeeFHhZ4f3Sit9baKJcz.jpg",
                    "mrp": 3599,
                    "price": 3599,
                    "size": "26",
            ...
            "variants": [
                {
                    "size": "S",
                    "image": "qygr4Qp2ATz5TpBqOLSkYpJa.jpg",
                    "mrp": 1299,
                    "price": 1299,
            ...
            "variants": [
                {
                    "image": "k1d2xPL3IqtRVRoU6KbKAUzo.jpg",
                    "mrp": 2799,
                    "price": 2799,
                    "size": "26",
            ...
            "variants": [
                {
                    "image": "NJB_V7Rmpvf3ULzx5WXgm5zq.jpg",
                    "mrp": 1999,
                    "price": 1999,
                    "size": "XS",
            ...
            "variants": [
                {
                    "image": "rvkIKygkUeZ3Zr8YNo7jxPPA.jpg",
                    "mrp": 1799,
                    "price": 1799,
                    "size": "39",
            ...
            "variants": [
                {
                    "price": 5190,
                    "size": "6",
                    "image": "Qq8ktx4drI4WnY3FKvg0Ic7V.jpg",
                    "mrp": 5190,
            ...
            "variants": [
                {
                    "size": "6",
                    "image": "xk4U_viiWUKhRtyB-WZzcmxT.jpg",
                    "mrp": 5190,
                    "price": 5190,
            ...
            "variants": [
                {
                    "image": "kMA-9tjsHRuo5dBYms8jvXuQ.jpg",
                    "mrp": 2499,
                    "price": 2499,
                    "size": "24",
            ...
            product_model_1.default.find({}, function (err, data) { data.forEach(function (data) { data.save(); }); });
...
category_model_1.default.find(function (err, data) {
    if (data.length < 1) {
        category_model_1.default.create({
            ...
            category_model_1.default.find({}, function (err, data) { data.forEach(function (data) { data.save(); }); });
...
brand_model_1.default.find(function (err, data) {
    if (data.length < 1) {
        brand_model_1.default.create({
            ...
            brand_model_1.default.find({}, function (err, data) { data.forEach(function (data) { data.save(); }); });
